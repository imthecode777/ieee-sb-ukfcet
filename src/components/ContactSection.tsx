      ...
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="animate-fade-in animation-delay-200 mt-4 text-lg text-muted-foreground text-balance">
            Have questions or want to join IEEE UKFCET? Reach out to us and we'll be happy to help.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="glass-card rounded-xl p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="mt-1 flex-shrink-0 rounded-md bg-primary/10 p-2">
                    <MapPin className="h-5 w-5 text-primary" />
                  </div>
                  <div className="ml-4">
                    <h4 className="text-base font-medium">Location</h4>
                    <p className="mt-1 text-muted-foreground">
                      IEEE UKFCET Student Branch,<br />
                      UKF College of Engineering and Technology,<br />
                      Parippally, Kollam, Kerala - 691302
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-muted-foreground">
                      <a href="mailto:ieee@ukfcet.ac.in" className="hover:text-primary">
                        ieee@ukfcet.ac.in
                      </a>
                    </p>
                  </div>
          ...
          <div className="animate-fade-in animation-delay-500">
            <div className="glass-card rounded-xl p-8 h-full">
              <h3 className="text-2xl font-bold mb-6" id="register">Send Us a Message</h3>
              ...
              {formState.submitted ? (
                <div className="h-full flex flex-col items-center justify-center py-12">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center px-4 py-2 border border-primary rounded-md text-sm font-medium text-primary bg-transparent hover:bg-primary/10 transition-colors"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                  >
